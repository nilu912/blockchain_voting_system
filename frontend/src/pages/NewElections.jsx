      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Set up a secure, transparent election powered by blockchain
            technology.
            <span className="block mt-2 text-[#023047] font-medium">
              Every vote will be securely recorded.
            </span>
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white/30 transition-all appearance-none"
                  style={{ color: "white" }}
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    name="startTime"
                    onChange={handleChange}
                    className="w-full px-4 py-3 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white/30 transition-all"
                    style={{ color: "white" }}
                  />
                </div>
                <div>
        ...
        <div className="mt-12 bg-blue-50 rounded-xl p-6 border border-blue-100">
          <h3 className="text-xl font-bold text-[#023047] mb-4">
            About Blockchain Elections
          </h3>
          <p className="text-gray-700 mb-4">
            Elections created on our platform are secured by blockchain
            technology, ensuring transparency, immutability, and verifiability.
            Once an election is created, it cannot be altered or tampered with.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm">
              ...
              <p className="text-sm text-gray-600">
                All votes are publicly verifiable
              </p>
            </div>
            <div className="bg-white rounded-lg p-4 shadow-sm">
              <div className="text-blue-500 mb-2">
              ...
              <p className="text-sm text-gray-600">
                Results cannot be altered once recorded
              </p>
            </div>
          </div>
        </div>
